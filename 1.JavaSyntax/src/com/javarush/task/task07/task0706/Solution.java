...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < house.length; i++) {
            if (i%2 == 0) k += house[i] = Integer.parseInt(reader.readLine());
            else m += house[i] = Integer.parseInt(reader.readLine());
        }
        System.out.println("В домах с " + (k >m?"":"не") + "четными номерами проживает больше жителей.");
    }
}