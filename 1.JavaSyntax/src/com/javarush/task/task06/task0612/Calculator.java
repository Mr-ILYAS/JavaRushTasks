...
public class Calculator{
    ...
    public static double division(int a,int b){return (double)a/b;}
    public static double percent(int a,int b){return (double)a*b*0.01;}
    public static void main(String[] args){System.out.println(division(100,20));}
}