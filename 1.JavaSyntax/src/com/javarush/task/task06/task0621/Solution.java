...
public class Solution{
    public static void main(String[] args) throws IOException{
        ...
        Cat catGrandpa=new Cat(reader.readLine(),null,null);
        Cat catGrandma=new Cat(reader.readLine(),null,null);
    ...
    public static class Cat{
        ...
        public String toString(){
            return "Cat name is "+name+(parent==null?", no mother":", mother is "+parent.name)+(parent2==null?", no father":", father is "+parent2.name);
        }
    }
}