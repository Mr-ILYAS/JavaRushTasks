...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        Path passwords = downloadFile("https://javarush.ru/testdata/secretPasswords.txt", Paths.get("C:\\Users\\Администратор\\Desktop"));
    ...
    public static Path downloadFile(String urlString, Path downloadDirectory) throws IOException {
        ...
        Path tmp=Files.createTempFile("name-[", "].tmp");
        Files.copy(i,tmp, StandardCopyOption.REPLACE_EXISTING);
        i.close();
