...
public class Solution implements List<Long>{
	public synchronized void trimToSize(){original.trimToSize();}
	public synchronized void ensureCapacity(int minCapacity){original.ensureCapacity(minCapacity);}
	...
	@Override
	public synchronized Object clone(){return original.clone();}
	...
	public synchronized void forEach(Consumer<? super Long> action){original.forEach(action);}
	public synchronized Spliterator<Long> spliterator(){return original.spliterator();}
	public synchronized boolean removeIf(Predicate<? super Long> filter){return original.removeIf(filter);}
	...
	@Override
	public synchronized boolean equals(Object o){return original.equals(o);}
	@Override
	public synchronized int hashCode(){return original.hashCode();}
	public synchronized boolean containsAll(Collection<?> c){return original.containsAll(c);}
	@Override
	public synchronized String toString(){return original.toString();}
	public synchronized Stream<Long> stream(){return original.stream();}
	public synchronized Stream<Long> parallelStream(){return original.parallelStream();}
