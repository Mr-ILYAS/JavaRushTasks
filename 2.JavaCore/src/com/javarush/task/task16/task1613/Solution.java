...
public class Solution{
	...
	public static class Clock extends Thread{
		...
		private void printTime() throws InterruptedException{
			...
			if(hours==0&&minutes==0&&seconds==0)System.out.println(String.format("В г. %s сейчас полночь!",cityName));
			else System.out.println(String.format("В г. %s сейчас %d:%d:%d!",cityName,hours,minutes,seconds));
		}
	}
}