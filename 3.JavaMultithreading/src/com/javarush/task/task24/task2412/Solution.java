...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(Comparator.comparing((Stock st) -> (String) st.get("name"))
                .thenComparing(st -> (Date) st.get("date"), Comparator.reverseOrder())
                .thenComparing(st -> st.containsKey("change") ? (double) st.get("change") : (double) st.get("last") - (double) st.get("open"), Comparator.reverseOrder())
        );
    }
