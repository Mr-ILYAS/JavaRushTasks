...
public class Hippodrome {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        game.getHorses().add(new Horse("Лошадь1", 3.0, 0.0));
        game.getHorses().add(new Horse("Лошадь2", 3.0, 0.0));
        game.getHorses().add(new Horse("Лошадь3", 3.0, 0.0));
        game.run();
        game.printWinner();
    }
    ...
    public void run() throws InterruptedException {
        for (int i = 0; i++ < 100; Thread.sleep(200)) {
            move();
            print();
        }
    }
