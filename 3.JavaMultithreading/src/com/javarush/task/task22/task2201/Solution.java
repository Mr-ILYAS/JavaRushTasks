...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        ...
        if(m.find()) {
            ...
            if (threadName.intern() == FIRST_THREAD_NAME) throw new TooShortStringFirstThreadException();
            else if (threadName.intern() == SECOND_THREAD_NAME) throw new TooShortStringSecondThreadException();
